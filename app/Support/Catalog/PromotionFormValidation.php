...
trait PromotionFormValidation
{
    ...
    public function messages(): array
    {
        return [
            ...
            'recurrence_starts_on.required' => 'Indica desde cuándo inicia la recurrencia.',
            'recurrence_starts_on.date' => 'La fecha de inicio de recurrencia no es válida.',
            'recurrence_ends_on.date' => 'La fecha de fin de recurrencia no es válida.',
            'recurrence_ends_on.after_or_equal' => 'La fecha de fin de recurrencia debe ser posterior o igual al inicio.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'recurrence_starts_on' => 'inicio de recurrencia',
            'recurrence_ends_on' => 'fin de recurrencia',
            'recurring_hours' => 'horarios recurrentes',
            'image' => 'imagen',
            'items' => 'ítems',
